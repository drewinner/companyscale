...
func main() {
	a := app.NewWithID("investor.tongs.com")
...
func makeMenu(a fyne.App, w fyne.Window) *fyne.MainMenu {
	...
	checkedItem := fyne.NewMenuItem("选取", nil)
	checkedItem.Checked = true
	disabledItem := fyne.NewMenuItem("禁用", nil)
	disabledItem.Disabled = true

	otherItem := fyne.NewMenuItem("其它", nil)
	mailItem := fyne.NewMenuItem("邮件", func() { fmt.Println("Menu New->Other->Mail") })
	mailItem.Icon = theme.MailComposeIcon()
	otherItem.ChildMenu = fyne.NewMenu("",
		fyne.NewMenuItem("项目", func() { fmt.Println("Menu New->Other->Project") }),
		mailItem,
	)

	fileItem := fyne.NewMenuItem("文件", func() { fmt.Println("Menu New->File") })
	fileItem.Icon = theme.FileIcon()
	dirItem := fyne.NewMenuItem("文件", func() { fmt.Println("Menu New->Directory") })
	...
	copyItem := fyne.NewMenuItem("拷贝", func() {
